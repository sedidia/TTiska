...
const CreateTeacherProcess = ({darkMode, courseSaved, saveCourses, nextStep}) => {
    ...
    return (
        <div className={darkMode ? "dark_object rounded p-4 position-relative col-md-12 col-lg-6 mb-4" : "bg-white rounded p-4 position-relative col-md-12 col-lg-6 mb-4"}>
                            <div className="card-body pt-3">
                                <h5 className={darkMode ? "card-title pb-4 text-light" : "card-title pb-4 text-dark"}>Etape 2 : enregistrement d'enseignements</h5>
                                ...
                                <form className="was-validated">
                                    ...
                                    :
                                    <Link to="" className="mt-3 btn btn-outline-info" onClick={(e) => nextStep(e, "createSemesters")}>Aller à Etape suivante du processus</Link>
                                    }
                                </form>
                            </div>
                        </div>
...
export default CreateTeacherProcess;