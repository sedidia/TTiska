...
const AttributeClasses = ( {darkMode, hangeMoveContentPage, activeContent, etats} ) => {
    return (
            ...
            <div>
                <div className=" row">
                    <div className={darkMode ? "dark_object rounded p-4 card-body pt-3 col-md-12 col-lg-6" : "bg-white rounded p-4 card-body pt-3 col-md-12 col-lg-6"}>
                        <h2 className={darkMode ? "card-title pb-4 text-light" : "card-title pb-4 text-dark"}>Attribuer des classes aux sections</h2>
